...
An AI-powered conflict resolution application that helps couples and teams work through disagreements using Nonviolent Communication (NVC) principles.

## What is Relationship Debugger?

Relationship Debugger acts as a neutral AI mediator that guides users through structured dialogue to understand each other's feelings and needs. Using evidence-based NVC techniques, it helps transform conflicts into opportunities for deeper connection and understanding.
...
Relationship Debugger guides users through the Nonviolent Communication process:
...
- [Nonviolent Communication](https://www.cnvc.org/) by Marshall Rosenberg
